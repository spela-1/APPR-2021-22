...
Podatke sem našla na Eurostaut in SiStatu, in jih uvozila kot CSV oz. HTML detoteke. Kasneje sem namesto tabele iz Eurostata raje uporabila samo podatke iz SiStata, saj so se zdeli bolj zanimivi (uvoz tabele iz Eurostata zakomentirala).

Podatke sem uredila v naslednje tabele:

1. _tabela "zlocinc" vsebuje podatke_:
...
V prvem grafu vidimo število obsojenih na 1000 prbivalcev po letu po slovenskih statističnih regijah.
...
Ker, sem mi je zdelo, da lahko iz grafa opazim korelacijo, sem se odločila, da bom iste podatke kasneje uporabila pri izdelavi napovednega modela in preverila, če hipoteza drži.
...
V tem grafu, sem želela prveriti, če katera od starostnih skupin močno izstopa po številu obsojenih. Vidimo, da je v starostni skupini do 20 let, malo obsojenih. To je zato, ker  podatki zaobjemajo le polnoletne osebe. Zdi se tudi, da je v starejših starostnih skupinah manjše število obosjenih.
...
Zanimalo me je, če so določena kaznima dejanja bolj pogosta glede na demografsek skupine.
Da bi bil graf za to čimbolj pregelden, sem vzela le deset najpogostejših zločinov.
...
Tako kot v drugem grafu, sem želela najti korelacijo med številom obosjenih na 1000 prebivalcev glede na izbrane parametre, tokrat glede na povprečno plačo. V tem primeru so podatki dani po občinah namesto statističnih regijah.
Ker pa nisem opazila nobene korelacije sem se odločila, da na bom nadeljevala s to analizo.

***

## Zemljevid 

*Števila obsojenih na 1000 prebivalcev po občinah v letu 2020*
...
Napovedni model sem naredila s podatki iz drudega grafa. Sprva sam upoštevala le število obsojenih na 1000 prebivalcev v odvisnosti od treh izbranih parametrov (stopnja revscine, kvalitata stanovanj, samoocena zadovoljstva), kasneje pa sem ugotovila, da je za manjšo napako pomembna tudi regija in leto.
Z prečnim preverjanjem, sem izračunala napako za napovedna modela: 
...
Ker je bila napaka pri linearnem modelu manjša, sem pri tem še izračunala, kokliko izbrane spremenljivke vplivjo na napoved
